...
\item
  So this is a member of the Crambidae family, and a member of an
  informal group colloquially known as `Grass moths'.
\item
...
\centering
\includegraphics{./images/Pcontaminella-PML-2021.jpg}
\caption{Note the posture of this living moth.}
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\item
  The set moth, which by the way, was rather battered before setting,
  does not reveal any useful features for ID.
\item
...
\begin{frame}{Finshed Image}
\protect\hypertarget{finshed-image}{}
\begin{columns}[T]
\begin{column}{0.5\textwidth}
\begin{itemize}
\tightlist
