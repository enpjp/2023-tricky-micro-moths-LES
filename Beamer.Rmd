...
"So this is a member of the Crambidae family, and a member of an informal group colloquially known as 'Grass moths'. ",
"*We have reduced the number of candidate species to about 17*."
  
)
supporting.image <- "Pcontaminella-PML-2021.jpg"
supporting.text <- "Note the posture of this living moth."
...
"The set moth, which by the way, was rather battered before setting, does not reveal any useful features for ID.",
